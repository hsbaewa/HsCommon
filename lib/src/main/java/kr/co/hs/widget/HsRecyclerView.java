...
//            return super.getItemViewType(position);
    ...
    public static abstract class HsViewHolder extends RecyclerView.ViewHolder implements OnClickListener, OnLongClickListener{
    ...
    public interface OnExpandableItemClickListener{
        void onItemClick(HsRecyclerView adapterView, View itemView, int parentPosition, int childPosition);
    }
    public interface OnExpandableItemLongClickListener{
        boolean onItemLongClick(HsRecyclerView adapterView, View itemView, int parentPosition, int childPosition);
    }
